				...
				<form id="join-form" name="joinForm" method="POST"
					...
					<spring:hasBindErrors name="userVo">
 					   <c:if test="${errors.hasFieldErrors('name') }">
 					        <br>
 					        <strong style="color: red"> ${errors.getFieldError( 'name' ) }<br>
								<c:set var="errorEmail" value="${errors.getFieldError( 'name' ).codes[0] }" />
								<spring:message code="${errorEmail }" text="${errors.getFieldError( 'name' ).defaultMessage }" /> 
							</strong>
 					   </c:if>
					...
					<spring:hasBindErrors name="userVo">
 					   <c:if test="${errors.hasFieldErrors('email') }">
 					        <br>
 					        <strong style="color: red"> ${errors.getFieldError( 'email' ) }<br>
